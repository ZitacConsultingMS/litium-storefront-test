...
import CaretDown from '../icons/zitac/caret-down';
  ...
  return (
    <Fragment>
      <div
        id={headerId}
        className={clsx(
          'flex cursor-pointer items-center justify-between whitespace-nowrap border-border py-5 first:border-t',
      ...
      >
        <Heading2 data-testid="accordion__header">
          {props.header || ''}
        </Heading2>
        {!expanded && (
        ...
        {expanded && (
          <CaretDown
            className={clsx('mr-4 h-4 w-4 rotate-[270deg]', props.classCssIcon)}
          />
        )}
      </div>
      <div
        ...
        role="region"
        className={clsx(
          'border-b border-border pb-8 pt-1 transition-all duration-200',
