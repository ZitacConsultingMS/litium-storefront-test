...
import CartContent from '../cart/zitac/CartContent';
...
function OrderConfirmation({
  ...
  return (
    <Fragment>
      ...
      <Text className="mt-2" data-testid="order-confirmation__thankyou">
        {t('orderconfirmation.yourordernumber')} {orderNumber}
      </Text>
      <section className="mt-14 flex flex-col gap-12 md:flex-row">
        <div>
          ...
          <Text
            className="mt-2"
            data-testid="order-confirmation__name-customer"
          >
      ...
      <section className="mt-14">
        ...
        <CartContent
          ...
          totalVat={totalVat}
        />
        <div className="my-2 flex justify-between gap-2 text-lg font-bold">
      ...
      <section className="my-14 text-center">
        ...
        {isLogged ? (
          <Link
            className="mx-auto my-4 block w-72 rounded-md bg-secondary p-4 text-center text-secondary"
