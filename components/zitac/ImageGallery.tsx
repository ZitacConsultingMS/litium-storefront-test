...
import ArtikelmedaljerTags, {
  hasActiveArtikelmedaljer,
} from '../products/zitac/Artikelmedaljer';
...
const ThumbsGallery = ({
  ...
  return (
    ...
    >
      {!fullscreen && (
        <>
          <ArtikelmedaljerTags fieldGroups={fieldGroups} />
          {hasActiveArtikelmedaljer(fieldGroups) && <div className="mb-8" />}
        </>
      )}
