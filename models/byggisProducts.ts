...
import { PointerMediaImageItem } from './pointers';
...
export interface ProductItem extends ContentItem {
  ...
  fields: {
    ...
    productBrand?: TextOption[] | null;
    articleColor: TextOption[] | null;
    articleSize: TextOption[] | null;
    articleWeightKg: string | null;
    productBullets: string;
    articleSupplierArtNr?: string | null;
    test: PointerMediaImageItem[] | null;
  };
