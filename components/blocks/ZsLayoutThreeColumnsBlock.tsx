...
export default function ZsLayoutThreeColumnsBlock(props: LayoutBlockProps) {
  const background = {
  ...
  return (
    ...
    >
      <div
        className={`${alignItems} mx-auto grid grid-cols-1 items-start gap-8 px-5 md:container md:grid-cols-3`}
      >
