...
export default function VariantsTable({
  ...
  const columns: IColumnType<ProductWithVariantsListProduct>[] = [
    ...
    },
    {
      ...
      render: ({ price }) => <Currency price={price?.unitPriceIncludingVat} />,
    },
    {
      key: 'articleNumber',
      title: '',
      ...
      <div className="mb-3 rounded border px-4 py-3">
        ...
        <Row className="pb-4">
          ...
          <Currency
            ...
            price={item.price?.unitPriceIncludingVat}
          />
        </Row>
        <Row>
          <QuantityInput
  ...
  return (
    <div className={clsx('mb-6 w-full md:mb-8 lg:mb-11', className)}>
