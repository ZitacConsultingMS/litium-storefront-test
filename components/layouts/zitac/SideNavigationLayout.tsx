...
import HamburgerMenu from 'components/icons/menu';
  ...
  return (
    ...
    >
      <div className="mb-2 flex items-center justify-between">
        ...
        />
        <label
          className="block cursor-pointer whitespace-nowrap rounded bg-hover p-1 md:hidden"
          htmlFor="toggleAside"
        ...
        />
        <label
          className="hidden cursor-pointer whitespace-nowrap rounded bg-hover p-1 md:block md:peer-checked/tablet:hidden"
      ...
      >
        {navigationButtonVisibility && (
          <Fragment>
            ...
            />
            <label
              className="cursor-pointer whitespace-nowrap rounded bg-hover p-1 md:mr-4 md:hidden mobile:peer-checked/mobile:hidden"
            ...
            />
            <label
              className="hidden cursor-pointer whitespace-nowrap rounded bg-hover p-1 peer-checked/tablet:hidden md:mr-4 md:block"
